...
public class XuAnimator {
    ...
    public static class AnimatorSetWrap{
         ...
         * @return
         */
        public AnimatorSetWrap then(View view, String animName,  TimeInterpolator interpolator, int repeatCount, int duration, float... values){
            if(view==null){
         ...
         * @return
         */
        public AnimatorSetWrap play(View view, String animName, TimeInterpolator interpolator,  int repeatCount, int duration, float... values){
         ...
         * @return
         */
        public AnimatorSetWrap before(View view, String animName,@Nullable TimeInterpolator interpolator,  int repeatCount,int duration, float... values){
        ...
        public AnimatorSetWrap with(View view, String animName,@Nullable TimeInterpolator interpolator, int repeatCount,int duration, float... values){
        ...
        public AnimatorSetWrap after(View view, String animName,@Nullable TimeInterpolator interpolator, int repeatCount, int duration, float... values){
